...
String URL_TO_LAB = "/labs/kundtStepperPro";
String URL_TO_USER_ID = "/labs/kundtStepperPro/userId";
String URL_TO_CHART_ID = "/labs/kundtStepperPro/chartId";
String URL_TO_IS_READY = "/labs/kundtStepperPro/isReady";
String URL_TO_EXECUTE = "/labs/kundtStepperPro/toExecute";
String URL_TO_IS_TIME_OUT = "/labs/kundtStepperPro/isTimeOut";
String URL_TO_FREQUENCY = "/labs/kundtStepperPro/frequency";
String URL_TO_STEP = "/labs/kundtStepperPro/step";
String URL_TO_SWITCH_STATE = "/labs/kundtStepperPro/switchState";

const int INITIAL_TUBE_LENGTH = 210;
const int MAX_TUBE_LENGTH = 180; // примерно
...
void setup() {
  ...
  URL_TO_CHART += "/charts/kundtStepperPro/users/" + userId + "/" + chartId;
...
void streamCallback(StreamData data) {
  ...
  // Получаем шаг, одна единица - 0,5 мм
  ...
  measurementsNumber = trunc (MAX_TUBE_LENGTH / (engineStep * 5)); // 5 - это шаг 5мм
...
void loop(void) {
  ...
  if ( inbound.parseStream( &Serial ) ) {
    ...
    if ( inbound.fullMatch ("V") ) {
      ...
      jsonXY.set("x", INITIAL_TUBE_LENGTH - measurementCount * engineStep * 5); // 5 - это шаг 5мм
